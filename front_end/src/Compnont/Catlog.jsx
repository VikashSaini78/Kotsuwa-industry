    ...
    <>
      ...
      <img src='./media/des4.webp' alt='error'/>
        {/* <div><Link>Home</Link><h6>Catlog</h6></div> */}
         ...
         <h2>Our Products</h2>
         <p>Sekawati Bags and Aprons, A highly acclaimed name - Sekawati, specializes in the manufacturing and export of a wide variety of Canvas Bags,
         ...
         <button className='catlog_button-1'>Drawstring Bag</button>
